...
<section class="user-info-container">
    <c:if test="${not empty isLoggedIn && isLoggedIn}">
        ...
        <ul class="nav">
            <li class="nav-item">
                <a class="nav-link" href="${pageContext.request.contextPath}/active-loans">Aktiva lån</a>
            </li>
            <li class="nav-item">
                <a class="nav-link" href="${pageContext.request.contextPath}/loan-history">Lånehistorik</a>
            </li>
        </ul>
        <a href="/logout">
    ...
    <c:if test="${empty isLoggedIn || !isLoggedIn}">
        <a href="/login">
...
<%@include file="/WEB-INF/fragment/user/navbar.jsp" %>